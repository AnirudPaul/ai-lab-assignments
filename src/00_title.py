...
# <div style="font-size:13px; margin-top:24px; color:#444; line-height:1.6;">Source code, figures and the executable notebook are available at<br><a href="https://github.com/AnirudPaul/ai-lab-assignments" style="color:#1F4E9C;">github.com/AnirudPaul/ai-lab-assignments</a></div>
# </div>
